...
import Common.driver.DriverContext;
...
public class AccionesWeb {    
    ...
    */ 
	...
	public WebElement FindElemento(String nombre, String plataforma) throws InterruptedException {
		...
		Common.Xml.LeerPasos xml = new Common.Xml.LeerPasos();
	...
	public WebElement BuscarElemento(String Tipo, String Objeto) throws IOException {
		...
		try {
			switch(Tipo) {
				case "Xpath": Elemento = Driver.findElement(By.xpath(Ruta)); break;
				case "PartialLinkText": Elemento = Driver.findElement(By.partialLinkText(Ruta)); break;
				case "Id": Elemento = Driver.findElement(By.id(Ruta)); break;
				case "Class": Elemento = Driver.findElement(By.className(Ruta)); break;
				case "Css": Elemento = Driver.findElement(By.cssSelector(Ruta)); break;
			}
		}
