...
import Common.constants.Navegador;
import Common.reporter.EstadoPrueba;
import Common.reporter.PdfBciReports;
...
public class DriverManager {
    ...
    private File root = new File("src\\test\\java\\resource\\");
